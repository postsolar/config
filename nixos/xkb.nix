...

{
  # TODO:
  # - test
  # - for anything other than basic intl keys, guillemets and other quote
  #    marks and often-accessed punctuation characters, use compose instead
  #    of complicating the config
