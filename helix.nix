...

{
  ...
  xdg.configFile = {
    ...
    "helix/languages.toml".text = # toml
      ...
      options.home-manager.expr = "(let flake = builtins.getFlake (toString ./.); names = builtins.attrNames flake.homeConfigurations; in flake.homeConfigurations.''${builtins.elemAt names 0}.options)"
